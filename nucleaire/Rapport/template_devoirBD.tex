...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../figures/07_spectre_background.png}
    \caption{Spectre de fond (background), généré par le code Python dans le dossier \texttt{scripts} (chemin relatif remontant d'un niveau depuis le dossier \texttt{rapport}).}
\end{figure}
