...
\usepackage{icomma} % virgule decimale en mode math sans espace parasite (0,99997 plutot que 0, 99997)
...
{\large Dates d'expérimentation: 10 et 17 septembre 2026 \quad $\vert$ \quad Remis le \today}
...
L'ensemble du traitement (localisation et ajustement des pics, régression d'étalonnage, génération des figures) est implémenté dans \texttt{nucleaire/scripts/analyse\_spectres.py} du dépôt du cours. Le script n'est pas reproduit intégralement ici (près de 500 lignes) afin de respecter la longueur cible du rapport; il demeure disponible dans le dépôt pour consultation ou reproduction des résultats.
